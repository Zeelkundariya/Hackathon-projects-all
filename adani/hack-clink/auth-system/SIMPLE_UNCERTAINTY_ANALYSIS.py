"""
Simple Demand Uncertainty Analysis - Bulletproof Implementation
"""
...
def render_simple_uncertainty_analysis():
    """Render simple demand uncertainty analysis page."""
    ...
    if run_analysis:
        try:
            with st.spinner("🔄 Running analysis..."):
                ...
                det_total_cost = total_production_cost + total_transport_cost + total_holding_cost
...
print("✅ Simple uncertainty analysis UI created successfully")
