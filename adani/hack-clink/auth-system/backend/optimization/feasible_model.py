"""Feasible Pyomo model builder with slack variables.

This file creates a feasible Pyomo model that can handle infeasible data
through slack variables and relaxed constraints.
"""
...
from backend.optimization.feasible_constraints import add_feasible_constraints
from backend.optimization.feasible_excel_loader import FeasibleExcelOptimizationData
from backend.optimization.feasible_objective import add_feasible_objective


def build_feasible_model(data: FeasibleExcelOptimizationData) -> pyo.ConcreteModel:
    """Build a feasible multi-period clinker allocation model with slack variables."""
    ...
    add_feasible_constraints(m)
    add_feasible_objective(m)
