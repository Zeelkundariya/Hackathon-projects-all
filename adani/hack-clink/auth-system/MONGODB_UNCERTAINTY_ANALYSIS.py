"""
MongoDB-based Demand Uncertainty Analysis - Uses User Input Data
"""
...
def render_mongodb_uncertainty_analysis():
    """Render MongoDB-based demand uncertainty analysis page."""
    ...
    versus when demand is known in advance using your input data.
    """)
    ...
    if 'user_input_data' not in st.session_state or not st.session_state.user_input_data:
        ...
        if st.button("📊 Input Data", type="primary"):
            st.session_state.navigation = "Data Input"
            st.rerun()
        return
    ...
    if run_analysis:
        try:
            with st.spinner("🔄 Running analysis..."):
                ...
                # Deterministic analysis using user's data
                ...
                # Simple holding cost
                total_holding_cost = sum(p["capacity"] for p in plants) * 5  # $5 per unit capacity
                ...
                class DeterministicMetrics:
                    def __init__(self):
                        ...
                        self.production_cost = total_production_cost
                        self.transport_cost = total_transport_cost
                        self.holding_cost = total_holding_cost
                ...
                # Stochastic analysis using scenarios
                ...
                for scenario in scenarios:
                    ...
                    for plant in plants:
                        # Allocate production based on capacity
...
print("✅ MongoDB-based uncertainty analysis UI created successfully")
